  ...
  <div class="container">
    ...
    <div class="row">
      <?php
        ...
        $sql = "SELECT users.userName,topic_head, topicId, topic_type, topic_content FROM `topics`
        inner join users
      ...
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            ...
            <button data-id="<?php echo $row['topicId'];?>" class="card-footer likeButton">Like</button>
          </div>
        </div>
      </div>
      <?php
